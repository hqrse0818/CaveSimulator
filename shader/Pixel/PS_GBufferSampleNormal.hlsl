...
PS_OUT main(PS_IN pin)
{
    ...
    pout.Normal = normalize(g_NormalTexture.Sample(g_SamplerState, pin.TexCoord)) * PBR[pin.MaterialID.r].NormalMap_Intensity;
    pout.Normal = normalize(pout.Normal + pin.NormalColor);
    pout.Normal.a = 1.0f;
